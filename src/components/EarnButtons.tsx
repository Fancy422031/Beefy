      ...
      <div className="mb-4 flex justify-between items-center">
        <div>
          <button
            ...
            onClick={() => 
              handleButtonClick([
                {id:1, network: 'eth', name: 'USDC-USDR sLP - 1', wallet: 0, deposited: 0, apy: '41.65%', tvl: '$7.54M'},
                {id:2, network: 'eth', name: 'USDC-USDR sLP - 2', wallet: 0, deposited: 0, apy: '41.65%', tvl: '$7.54M'}
                ])
            } 
